...
<body>
    <nav>
         <ul class="sidebar">
            ...
            <li><a href="../PHPgames.php">Games</a></li>
            <li><a href="../PHP/login_register.php">Inloggen/Registreren</a></li>
        </ul>
        <ul>
            <li><img class="playgridLogo" src="../img/Logoplaygrid.png" alt="logo"></li>
            <li class="hideOnMobile"><a href="../PHP/index.php">Home</a></li>
            <li class="hideOnMobile"><a href="../PHP/games.php">Games</a></li>
            <li class="hideOnMobile"><a href="../PHP/login_register.php">Inloggen/Registreren</a></li>
